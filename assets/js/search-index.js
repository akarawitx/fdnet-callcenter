...
var B = (window.BASE_URL || '').replace(/\/$/, '');
window.SITE_SEARCH_INDEX = [

  // หน้าหลัก
  {
    title: 'หน้าหลัก', desc: 'กองบริการสารสนเทศ วัดพระธรรมกาย', url: B + '/index.php', section: 'หน้าหลัก',
  ...
  // ── บริการ IT ──────────────────────────────────────────────
  {
    ...
    url: B + '/pages/services.php?cat=account', section: 'บริการ IT',
...

  {
    ...
    url: B + '/pages/services.php?cat=renew', section: 'บริการ IT',
...

  {
    ...
    url: B + '/pages/services.php?cat=status', section: 'บริการ IT',
...

  {
    ...
    url: B + '/pages/services.php?cat=reset', section: 'บริการ IT',
...

  {
    ...
    url: B + '/pages/services.php?cat=domain', section: 'บริการ IT',
...

  {
    ...
    url: B + '/pages/services.php?cat=access', section: 'บริการ IT',
...

  {
    ...
    url: B + '/pages/services.php?cat=internet', section: 'บริการ IT',
...

  {
    ...
    url: B + '/pages/services.php?cat=quota', section: 'บริการ IT',
  ...
  // ── แจ้งปัญหา / FAQ ─────────────────────────────────────────
  {
    ...
    url: B + '/pages/support.php?cat=redlogin', section: 'แจ้งปัญหา',
...

  {
    ...
    url: B + '/pages/support.php?cat=redlogin', section: 'แจ้งปัญหา',
    keywords: 'ล็อค lock บัญชี ใส่รหัสผ่านผิด หลายครั้ง 30 ครั้ง ชั่วโมง ล็อคอัตโนมัติ ปลดล็อค'
  },
...

  {
    ...
    url: B + '/pages/support.php?cat=hrweb', section: 'แจ้งปัญหา',
  ...
  // ── คู่มือ ──────────────────────────────────────────────────
  {
    ...
    url: B + '/pages/manual.php?cat=network', section: 'คู่มือ',
...

  {
    ...
    url: B + '/pages/manual.php?cat=security', section: 'คู่มือ',
...

  {
    ...
    url: B + '/pages/manual.php?cat=domain', section: 'คู่มือ',
...

  {
    ...
    url: B + '/pages/manual.php?cat=tools', section: 'คู่มือ',
...

  {
    ...
    url: B + '/pages/manual.php?cat=documents', section: 'คู่มือ',
  ...
  // ── จัดหาอุปกรณ์ ────────────────────────────────────────────
  {
    ...
    url: B + '/pages/procurement.php?cat=accessControl', section: 'จัดหาอุปกรณ์',
...

  {
    ...
    url: B + '/pages/procurement.php?cat=cctv', section: 'จัดหาอุปกรณ์',
...

  {
    ...
    url: B + '/pages/procurement.php?cat=vpn&mail', section: 'จัดหาอุปกรณ์',
...

  {
    ...
    url: B + '/pages/procurement.php?cat=gbn', section: 'จัดหาอุปกรณ์',
    keywords: 'gbn กล่องสัญญาณ สัญญาณ กล่อง set top box ดาวเทียม'
  },

  {
    title: 'ขอใช้งานจอ LED', desc: 'ขั้นตอนการขอใช้งานจอ LED',
    url: B + '/pages/procurement.php?cat=led', section: 'จัดหาอุปกรณ์',
...

  {
    ...
    url: B + '/pages/procurement.php?cat=server', section: 'จัดหาอุปกรณ์',
...

  {
    ...
    url: B + '/pages/procurement.php?cat=wifi&lan', section: 'จัดหาอุปกรณ์',
...

  {
    ...
    url: B + '/pages/procurement.php?cat=telephonebill', section: 'จัดหาอุปกรณ์',
...

  {
    ...
    url: B + '/pages/procurement.php?cat=printDocument', section: 'จัดหาอุปกรณ์',
...

  {
    ...
    url: B + '/pages/procurement.php?cat=fileShred', section: 'จัดหาอุปกรณ์',
  ...
  
  {
    ...
    url: B + '/pages/procurement.php?cat=training', section: 'จัดหาอุปกรณ์',
...

  {
    ...
    url: B + '/pages/procurement.php?cat=it&com', section: 'จัดหาอุปกรณ์',
...

  {
    ...
    url: B + '/pages/procurement.php?cat=video', section: 'จัดหาอุปกรณ์',
...

  {
    ...
    url: B + '/pages/procurement.php?cat=audio', section: 'จัดหาอุปกรณ์',
...

  {
    ...
    url: B + '/pages/procurement.php?cat=radio', section: 'จัดหาอุปกรณ์',
...

  {
    ...
    url: B + '/pages/procurement.php?cat=location', section: 'จัดหาอุปกรณ์',
  ...
  // ── เครือข่าย ───────────────────────────────────────────────
  {
    ...
    url: B + '/pages/network.php?cat=network', section: 'เครือข่าย',
