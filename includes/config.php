    ...
    return [
        ...
        [
            ...
            'children' => [
                ...
                ['label' => 'รีเซ็ตรหัสผ่าน',       'url' => "$b/pages/services.php?cat=reset"],
                ['label' => 'ขอ Email องค์กร',       'url' => "$b/pages/services.php?cat=email"],
                ['label' => 'แจ้งปัญหา / Helpdesk',  'url' => "$b/pages/services.php?cat=helpdesk"],
                ['label' => 'ขอใช้ Wi-Fi',           'url' => "$b/pages/services.php?cat=wifi"],
                ['label' => 'ขอซอฟต์แวร์',          'url' => "$b/pages/services.php?cat=software"],
            ],
        ],
        [
